...
The [provider-testprovider](https://github.com/frigaut-orange/test-provider) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-testprovider](https://github.com/crossplane-contrib/provider-jet-testprovider) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/frigaut-orange/test-provider/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/frigaut-orange/test-provider/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/frigaut-orange/test-provider/blob/main/hack/boilerplate.go.txt](https://github.com/frigaut-orange/test-provider/blob/main/hack/boilerplate.go.txt)
...
The [provider-testprovider](https://github.com/frigaut-orange/test-provider)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/frigaut-orange/test-provider/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/frigaut-orange/test-provider/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue testproviders (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/frigaut-orange/test-provider/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request TestProviders: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/frigaut-orange/test-provider/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
